    ...
    <div class="login-container">
      ...
      >
        ...
        <el-form-item prop="username">
          ...
          <el-tooltip
            content="仅支持大小写字母、下划线、数字、- _ ? ! * @.中的字符命名"
        ...
        <el-form-item prop="password">
          ...
          <el-tooltip
            content="仅支持大小写字母、下划线、数字、- _ ? ! * @.中的字符字符且长度6个或以上"
            placement="right-start"
            effect="light"
            :hide-after="4000"
          >
        ...
        <div class="register">
          <span style="font-size: 15px; color: white">
            没有账号，立即
            <el-link type="primary" style="font-size: 15px" @click="open">
              <u>加入我们</u>
              ...
              <div class="demo-drawer__content">
                ...
                <div class="register-input">
                  ...
                  <i
                    ...
                    style="font-size:16px;color: #2ac06d;padding-left: 20px"
                  />
...
export default {
  ...
  methods: {
    ...
    handleRegis() {
      console.log(
        this.regisForm.isUsername,
        this.regisForm.isPassword,
        this.regisForm.isEmail,
        this.regisForm.capture
      );
      if (
        this.regisForm.isUsername &&
        this.regisForm.isPassword &&
